...
public sealed class ClassifiedAdCommandsApi : ControllerBase
{
    ...
    private readonly ILogger<ClassifiedAdCommandsApi> _logger;
    private readonly ClassifiedAdsApplicationService _service;

    public ClassifiedAdCommandsApi(IRequestHandler handler,
                                   ClassifiedAdsApplicationService service,
                                   ILogger<ClassifiedAdCommandsApi> logger)
    {
        _handler = handler;
        _service = service;
        _logger = logger;
