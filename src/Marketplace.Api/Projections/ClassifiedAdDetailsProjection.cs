...
internal sealed class ClassifiedAdDetailsProjection : IProjection
{
    ...
    public ClassifiedAdDetailsProjection(IList<ReadModels.ClassifiedAdDetails> items) => _items = items;
    ...
    public Task ProjectAsync(IEvent @event)
    {
        Action project = @event switch
        {
            AdEvent.ClassifiedAdCreated e => () =>
                _items.Add(new ReadModels.ClassifiedAdDetails {Id = e.Id, SellerId = e.Id}),
